...
// Mock data for SriGanesh
const sriGaneshGame: Game = {
  id: 'sriganesh',
  name: 'SriGanesh',
  type: 'jodi',
  category: 'main',
...
const mockBets: Bet[] = [
  {
    ...
    potentialWin: 7600,
    status: 'won',
    placedAt: new Date('2024-01-15T11:45:00'),
    session: 'open'
  },
  {
    id: 'bet-2',
    ...
    potentialWin: 142500,
    status: 'won',
    placedAt: new Date('2024-01-15T11:30:00'),
    session: 'close'
  }
]

export default function SriGaneshPage() {
  const [game, setGame] = useState<Game>(sriGaneshGame)
