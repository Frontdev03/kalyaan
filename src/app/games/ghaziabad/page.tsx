...
// Mock data for Ghaziabad
const ghaziabadGame: Game = {
  id: 'ghaziabad',
  name: 'Ghaziabad',
  type: 'jodi',
...
const mockBets: Bet[] = [
  {
    ...
    potentialWin: 3800,
    status: 'won',
    placedAt: new Date('2024-01-15T17:45:00'),
    session: 'open'
  }
]

export default function GhaziabadPage() {
  const [game, setGame] = useState<Game>(ghaziabadGame)
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">1 winner today</p>
            </div>
