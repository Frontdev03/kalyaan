...
import { Game, Bet, GameSettings, GameResult } from '@/types'
...
// Mock data for Rajdhani Day
const rajdhaniDayGame: Game = {
  id: 'rajdhani-day',
  name: 'Rajdhani Day',
  type: 'jodi',
  category: 'main',
...
const mockBets: Bet[] = [
  ...
  },
  {
    ...
    potentialWin: 4750,
    multiplier: 95,
    placedAt: new Date('2024-01-15T15:00:00'),
    status: 'won',
    session: 'close'
  },
  {
    ...
    potentialWin: 2375,
    multiplier: 950,
    placedAt: new Date('2024-01-15T16:45:00'),
    status: 'lost',
    session: 'close'
  }
]

export default function RajdhaniDayManagement() {
  const [game, setGame] = useState<Game>(rajdhaniDayGame)
      ...
      <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg p-6 text-white">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="mt-2 text-purple-100">Premium afternoon game with high stakes</p>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">3 winners today</p>
            </div>
        ...
        <div className="p-6">
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* Recent Activity */}
              <div className="space-y-4">
                <h4 className="text-lg font-semibold text-gray-900">Today&apos;s Summary</h4>
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-3 px-4 bg-blue-50 rounded-lg">
                    <span className="text-blue-700">Active Bets</span>
                    <span className="font-bold text-blue-600">{activeBets}</span>
                  </div>
                ...
                <table className="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {bets.slice(0, 5).map((bet) => (
                      <tr key={bet.id}>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{bet.userId}</td>
